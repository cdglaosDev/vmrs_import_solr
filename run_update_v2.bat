...
C:\curl-7.51.0\bin\curl http://192.168.1.117:8983/solr/select/?q^=type_t:"vehiclereg"^&fq^=update_time:\[%Yesterday%T00:00:00Z+TO+%Yesterday%T23:59:59Z\]^&wt^=csv^&indent^=true^&start^=0^&rows^=100000^&fl^=note_id_t,advance_t,
axis_t,birth_district_t,birth_province_t,birth_village_t,car_t,cat_t,cc_t,chassis_no_t,color_t,commerce_permit_t,commerce_permit_date_t,commerce_permit_no_t,changelog_t,create_date_t,customer_id_t,cylinder_t,
data_code_t,dateofbirth_t,department_t,d2_t,d4_t,d5_t,d6_t,d7_t,d_t,district_t,division_no_t,driverseat_t,editedby_t,email_address_t,encoder_t,energy_t,entry_date_t,entryby_t,engine_no_t,expire_date_t,expire_date_val_t,
exam_date_t,exam_place_t,examdate_A_t,examdate_B_t,examdates_t,examtype_t,eye_color_t,fine4_t,fine9_t,fine13_t,fine29_t,fine30_t,fine31_t,finedate_t,finelocation_t,finelog_t,fax_t,height_t,import_permit_date_t,
import_permit_hsny_t,import_permit_invest_t,import_permit_no_t,in1_t,industrial_doc_date_t,industrial_doc_no_t,issue_date_t,issue_date_var_t,issue_place_t,keyby_t,name_t,lastname_t,length_t,license_no_t,log_t,
make_t,mistakeby_t,model_t,motor_make_t,modify_date,modify_date_t,made_out_t,number_t,nationality_inter_t,nationality_lao_t,occupation_t,paper_t,person_id_t,policenote_t,police_doc_date_t,police_doc_no_t,
print_count_t,print_date_1_t,print_no_1_t,print_user_1_t,printedby_t,printlog_t,province_t,province_no_t,province_code_t,province_abbr_t,purpose_t,purpose_no_t,quick_id_t,releasedate_t,resolution_t,row_t,
remark_t,remark2_t,rfid_t,save1_t,seats_t,sex_t,social_security_t,special_t,special_date_t,special_remark_t,tax_10_40_t,tax_12_t,tax_50_t,tax_date_t,tax_exem_t,tax_no_t,tax_payment_date_t,tax_payment_no_t,
tax_permit_t,tax_receipt_t,tax_t,techincal_id_t,technical_doc_date_t,technical_doc_no_t,telephone_t,type_t,update_time,update_time_t,vehicletype_t,village_t,work_phone_t,weight_empty_t,weight_filled_t,
weight_total_t,wheels_t,width_t,year_manufactured_t,home_phone_t,mobile_t,certno_t,certdate_t,certperm_t,certtemp_t,certcode_t,certlicense_t,certolddate_t,access_t,_olddata_t,_ver_t,tuk_t,counted_t,v_t,
title_t,box_a1_t,box_a5_t,deleted,deleted_t,date_replace_t,document_id_t,id,id_t,open_date1_t,sengphet_t,serial_a_t,owner_t,object_id_t,parent_id_t,f5_t,g5_t,h5_t,di_t,last_print_by_t,last_print_date_t,
printedat_t,score_t,flag_t,ati_color_1_t,ati_note_no1_t,ati_note_no2_t,certify_doc_date_t,certify_doc_number_t,certify_doc_remark_t,collected_t,create_new_t,create_newm_t,create_year_t,createday_t,
doc1_cnt_t,doc2_cnt_t,doc3_cnt_t,doc4_cnt_t,doc5_cnt_t,doc6_cnt_t,group_t,owner_name_t,technicalcenter_t,technicalcheck_t,tempodate_t,tempoduration_t,tempono_t,temporemark_t,tnic_date_t,
tnic_expire_date_t,tnic_result_t,today_t,transfer_date_t,transfer_name_t,transfer_number_t,transfer_province_t,transfer_remark_t,undeleted_by_t,undeleted_date_t,certprintdate_t > update_data.csv

D:\xampp\mysql\bin\mysql --user=root --database=dbvrms < import.sql
echo Import success!
